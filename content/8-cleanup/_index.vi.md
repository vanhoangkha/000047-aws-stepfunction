...
![StepFunctions](/images/SF/c01.png?width=90pc)

2. Click **Stop execution** để dừng thực thi state machine.
![StepFunctions](/images/SF/c02.png?width=90pc)
...
3. Quay trở lại giao diện Cloud9 Instance. chạy lệnh sau để thực hiện xóa AWS CloudFormation stack mà AWS SAM đã tạo cho ứng dụng của chúng ta.
```
...
```
![StepFunctions](/images/SF/c03.png?width=90pc)

4. Truy cập vào giao diện quản lý [dịch vụ Cloud9](https://ap-southeast-1.console.aws.amazon.com/cloud9/home?region=ap-southeast-1)
  + Chọn Cloud9 Instance **StepFunctions**.
  + Click **Delete**.
![StepFunctions](/images/SF/c04.png?width=90pc)

5. Điền **Delete** để xác nhận.
  + Click **Delete** để tiến hành xóa Cloud9 Instance.
![StepFunctions](/images/SF/c05.png?width=90pc)
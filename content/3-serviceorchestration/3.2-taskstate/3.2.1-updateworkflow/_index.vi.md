...
1. Quay trở lại giao diện Terminal của Cloud9, chạy lệnh dưới đây, để xác định được **ARN** của **DataCheckingFunction**. ( Đảm bảo rằng bạn đang ở vị trí thư mục **workshop-dir**. )
